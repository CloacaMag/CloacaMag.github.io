...
function Quinnrfairchild(){
    return <div >
            <p>
              <strong>Tricks of the Rind</strong>
              <br />
              <pre style={{wordBreak:"normal",wordWrap:"normal",height:"100%",width:"90vw",overflow:"auto",whiteSpace:"pre-wrap"}}>
              <br />My hand recoils as I reach for the fruit bowl. The mini watermelon, which I
    ...
    bare and striped green; I lightly stroke it, expecting the give of face
    ...
    think suddenly of eggs, and scoop it into my hands. A few hairs carch at
  ...
  <br />
    ...
    as I try to tug a cogent thought from my addled mind, but nothing fits
    fruit suddenly takes on human qualities. I establish that I can’t (won’t)
    eat it, but beyond that, logic flings itself into a precipice. So I reach
    ...
    amidst the aftermath.
              ...
              <br />
              <br />
              <img src='https://web.archive.org/web/20090902002637/http://www.geocities.com/redondoguy2001/Halloween/pumpkins_lighted.gif' style={{width:'10vw',height:'10vw',marginLeft:'40vw'}}/>
              </p>
        </div>
}
...
export {Quinnrfairchild,Quinnrfairchildbio}